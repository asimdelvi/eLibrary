export const Input = ({ type, placeholder, formFunction }) => {
  ...
  const fileInputClass =
    "file:cursor-pointer m-2 border-dashed border-2 border-black cursor-pointer w-full file:bg-[#dddddd] file:text-lg file:p-2 file:border-0 file:rounded-l-lg rounded-lg bg-white";
